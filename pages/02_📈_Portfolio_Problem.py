...
if selected_Optimization == "Hill Climbing":
    ...
    stocks_set = ["Conjuntos de ativos 1", "Conjuntos de ativos 2", "Conjuntos de ativos 3", "Custom"]
    selected_instance = st.selectbox("Conjuntos de ativos", stocks_set)
    ...
    if selected_instance == "Conjuntos de ativos 1":
        st.markdown(
        """
        "WEGE3.SA", "LREN3.SA", "VALE3.SA", "PETR4.SA", "EQTL3.SA"
    ...
    elif selected_instance == "Conjuntos de ativos 2":
        st.markdown(
        """
        "EGIE3.SA","NIKE34.SA", "ABEV3.SA","BBDC3.SA","MGLU3.SA"
        """
        )
    if selected_instance == "Conjuntos de ativos 3":
        st.markdown(
        """
        "NUBR33.SA","ITSA4.SA", "CEAB3.SA","SNEC34.SA","CRFB3.SA"
        """
